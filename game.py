...
touch = False
pos = 0
BullLeft = pygame.image.load('Ammo L.png')
BullRight = pygame.image.load('Ammo R.png')
BL = pygame.image.load('Left.png')
BR = pygame.image.load('Right.png')
BJ = pygame.image.load('Jump.png')
BRes = pygame.image.load('Resume.png')
BPause = pygame.image.load('Pause.png')
#PPP = pygame.image.load('A.png')
...
class Bullet(object):
    ...
    def shot(self, win, champ):
        if self.x >= -self.width and self.x <= L:
            if self.direction == 1:
                self.x += self.speed
                win.blit(BullRight, (self.x,self.y))
            elif self.direction == -1:
                self.x -= self.speed
                win.blit(BullLeft, (self.x,self.y))
...
Jump = button(L-120, H-110, 40, 40)
Left = button(10, H-110, 40, 40)
Right = button(70, H-110, 40, 40)
Shoot = button(L-60, H-110, 40, 40)
Menu = button(L-50,10,20,20)
Resume = button(int(L/2)-50,50,100,20)
